...
public class Student
{
    public static void main(String[] args)
    {
        ...
        studentName.add("Jeff");
        studentName.add("Bob");
        studentName.add("Sam");
        studentName.add("Bartholomew");
...
You can't have a float data type in an arrayList defined for strings. This code works because it only has Strings.
...
This means that we should be able to use an ArrayList to hold data.

- Answer the following questions:

    * Look back at *Size of the `ArrayList`*. What does the code output and why?
    It says that the list is 0.
