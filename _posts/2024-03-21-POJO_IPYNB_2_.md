...
A public and private class are different, as public objects are accessible by all other things in the program, while a private object is confined to it's local class or method.
...
You would use a private access controller when you want to restrict access to a variable or method to only the class that it is in. You would use a public access controller when you want to allow access to a variable or method to all classes in the program.
