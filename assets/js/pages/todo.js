...
function getNewQuote() {
    ...
    xhr.addEventListener('readystatechange', function () {
    	if (this.readyState === this.DONE) {
            ...
            document.getElementById("quote").innerHTML = quoteParsed["quote"];
            document.getElementById("author").innerHTML = quoteParsed["name"];
            console.log(quoteParsed["author"]);
            console.log(quoteParsed["text"]);
    	}
    });

    xhr.open('POST', 'https://quotel-quotes.p.rapidapi.com/quotes/random');
    xhr.setRequestHeader('content-type', 'application/json');
    xhr.setRequestHeader('X-RapidAPI-Key', 'eb0bbc6cc0msh085b254f1761bc2p154cf4jsne59a8dbdbaa0');
    xhr.setRequestHeader('X-RapidAPI-Host', 'quotel-quotes.p.rapidapi.com');
